...
public class ProjectModel implements org.drools.modelcompiler.CanonicalKieModuleModel {
    ...
    public java.util.List<Model> getModels() {
        return java.util.Arrays.asList(new org.redhat.appdev.Rules6D95183FF81C3BE8833BC564CE42BA8C_TransactionValidationService());
    }

    public java.util.List<Model> getModelsForKieBase(String kieBaseName) {
        switch (kieBaseName) {
            case "defaultKieBase": return getModels();
            case "org$redhat$appdev$TransactionValidationServiceKieBase": return java.util.Arrays.asList(new org.redhat.appdev.Rules6D95183FF81C3BE8833BC564CE42BA8C_TransactionValidationService());
        }
...
public org.kie.api.builder.model.KieModuleModel getKieModuleModel() {
    ...
    org.kie.api.builder.model.KieBaseModel kieBaseModel_org$redhat$appdev$TransactionValidationServiceKieBase = kModuleModel.newKieBaseModel("org$redhat$appdev$TransactionValidationServiceKieBase");
    kieBaseModel_org$redhat$appdev$TransactionValidationServiceKieBase.setEventProcessingMode(org.kie.api.conf.EventProcessingOption.CLOUD);
    kieBaseModel_org$redhat$appdev$TransactionValidationServiceKieBase.addPackage("org.redhat.appdev");
    org.kie.api.builder.model.KieSessionModel kieSessionModel_org$redhat$appdev$TransactionValidationServiceKieSession = kieBaseModel_org$redhat$appdev$TransactionValidationServiceKieBase.newKieSessionModel("org$redhat$appdev$TransactionValidationServiceKieSession");
    kieSessionModel_org$redhat$appdev$TransactionValidationServiceKieSession.setType(org.kie.api.builder.model.KieSessionModel.KieSessionType.STATEFUL);
    kieSessionModel_org$redhat$appdev$TransactionValidationServiceKieSession.setClockType(org.kie.api.runtime.conf.ClockTypeOption.get("realtime"));
    return kModuleModel;
}
}